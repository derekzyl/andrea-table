  ...
  var Ut = function(e) {
    ...
    if (h) {
      ...
      for (A = h.length; A--; ) {
        ...
        if (r = m === "value" ? t.value : Jt(t.value), u = T(m), v.attrName = u, v.attrValue = r, v.keepAttr = !0, v.forceKeepAttr = void 0, C("uponSanitizeAttribute", e, v), r = v.attrValue, Ae && _(/((--!?|])>)|<\/(style|title)/i, r)) {
          ne(m, e);
          continue;
        }
...
//# sourceMappingURL=purify.es-BwOkayRK.mjs.map
